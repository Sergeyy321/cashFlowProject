        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 md:gap-3 shrink-0">
          ...
          <div className="flex items-center gap-1 sm:gap-1.5">
            <a
              ...
              aria-label="Telegram"
              title="Telegram"
              className={`flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 rounded-lg sm:rounded-xl md:rounded-2xl bg-zinc-900/90 border border-zinc-800/90 text-zinc-400 transition-all duration-200 cursor-pointer hover:scale-105 active:scale-95 shadow-inner ${
                activePage === 'woodiq'
                  ? 'hover:border-amber-400/60 hover:text-amber-300'
                  : 'hover:border-lime-400/60 hover:text-lime-300'
              }`}
            >
            ...
            <a
              href={activePage === 'cashflow' ? 'https://www.instagram.com/cashflowkatowice/' : 'https://www.instagram.com/woodiq.pl/'}
              target="_blank"
              rel="noopener noreferrer"
