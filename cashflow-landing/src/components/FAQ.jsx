export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'В среднем 4-5 часов: 20 минут теории и разбор правил, 3-4 часа чистой игры и 40 минут финального подведения итогов, разбора ваших жизненных паттернов поведения и нетворкинга.'
    }
  ];
